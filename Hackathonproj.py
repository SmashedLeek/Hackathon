...
def cor():
    ...
    if int(current_time) >= 83000 and int(current_time) <= 103000:
        ...
        ins = carbs / 40
        tkinter.messagebox.showinfo('insuline' , Ans)
...
"""show_btn = Button(app, text='Show', width=12, command=ans)
show_btn.grid(row=4, column=1, sticky=W, pady=4)""" # not seeming to show up in gui and working with the def function for showing output into gui entry box.
